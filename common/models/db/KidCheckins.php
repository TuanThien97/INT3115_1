...
/**
 * This is the model class for table "kid_checkins".
 *
 * @property int $id
 * @property int $kid_id
 ...
 */
class KidCheckins extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['kid_id', 'class_id', 'teacher_id', 'status', 'is_qrcode'], 'default', 'value' => null],
            [['kid_id', 'class_id', 'teacher_id', 'status', 'is_qrcode'], 'integer'],
    ...
    {
        return $this->hasMany(KidCheckinPhotos::className(), ['kid_checkin_id' => 'id']);
    }
