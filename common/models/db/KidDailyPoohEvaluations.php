...
/**
 * This is the model class for table "kid_daily_pooh_evaluations".
 *
 * @property int $id
 * @property int $kid_id
 ...
 */
class KidDailyPoohEvaluations extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'kid_daily_pooh_evaluations';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['kid_id', 'class_id', 'teacher_id', 'count_pooh', 'status'], 'default', 'value' => null],
            [['kid_id', 'class_id', 'teacher_id', 'count_pooh', 'status'], 'integer'],
