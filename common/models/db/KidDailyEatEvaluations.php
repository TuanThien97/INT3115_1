...
/**
 * This is the model class for table "kid_daily_eat_evaluations".
 *
 * @property int $id
 * @property int $kid_id
 ...
 *
 * @property KidDailyEatEvaluationSchoolMeals[] $kidDailyEatEvaluationSchoolMeals
 * @property Classes $class
 * @property Kids $kid
 * @property Teachers $teacher
 */
class KidDailyEatEvaluations extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'kid_daily_eat_evaluations';
    }
     ...
     */
    public function getKidDailyEatEvaluationSchoolMeals()
    {
        return $this->hasMany(KidDailyEatEvaluationSchoolMeals::className(), ['kid_daily_eat_evaluation_id' => 'id']);
    }
