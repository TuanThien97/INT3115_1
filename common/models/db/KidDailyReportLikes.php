...
/**
 * This is the model class for table "kid_daily_report_likes".
 *
 * @property int $id
 ...
 */
class KidDailyReportLikes extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
