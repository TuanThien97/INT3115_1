...
/**
 * This is the model class for table "kid_daily_sleep_evaluations".
 *
 * @property int $id
 * @property int $kid_id
 ...
 */
class KidDailySleepEvaluations extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'kid_daily_sleep_evaluations';
    }
